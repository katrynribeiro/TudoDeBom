...
public class Carrinho {
	...
	public String toString() {
		return "IDProduto=" + idProduto + "| Produto= " + produto + "| Estoque após Pedido = "
				+ quantidadeRestante + " Pedido Solicitado =" + quantPedido ;
	}
	...
	public void setCarrinho(List<Carrinho> carrinho) {
		carrinho = new  ArrayList<Carrinho>(carrinho);
	}
